...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        final List<Privilege> managerPrivileges = new ArrayList<Privilege>(Arrays.asList(managerPrivilege, readPrivilege));
        ...
        createUserIfNotFound("manager@test.com", "Manager", "Role", "test", new ArrayList<Role>(Arrays.asList(managerRole)));
